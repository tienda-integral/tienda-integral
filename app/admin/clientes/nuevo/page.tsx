  ...
  return (
    <main className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-3xl mb-6 flex justify-between items-center">
        <h1 className="text-4xl font-bold text-blue-700">Nuevo Cliente</h1>
        <Link
          href="/admin/clientes"
      ...
      >
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            required
            placeholder="Ej: Impresos del Norte S.R.L."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block mb-2 font-semibold">CUIT / Identificación Fiscal *</label>
            <input
              name="cuit"
              type="text"
              required
